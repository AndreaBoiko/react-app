  ...
  return (
    <>
                    ...
                    <div className="flex space-x-4">
                      ...
                      {loggedIn ? (
                        <NavLink
                          ...
                          className="no-underline rounded-md px-3 py-2 text-sm font-medium no-underline text-gray-300 hover:bg-gray-700 hover:text-white">
                          Logout
                        </NavLink>
                      ) : (
                        <NavLink
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) => {
                      return (
                        ...
                        (isActive
                          ? 'no-underline box-border bg-gray-900 text-white'
                          : 'no-underline text-gray-300 hover:bg-gray-700 hover:text-white')
                      );
                    }}>
                    {item.name}
      ...
      <div className="bg-gray-200">
        <div className="p-[25px] min-h-screen max-w-7xl mx-auto">{props.children}</div>
      </div>
    </>
  );
}
